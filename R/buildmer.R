...
#' @template seealso
#' @export
buildbam <- function (formula,data=NULL,family='gaussian',cl=NULL,direction=c('order','backward'),crit='LRT',keep=NULL,calc.anova=TRUE,calc.summary=TRUE,quiet=FALSE,...) {
	p <- list(
		formula=formula,
		data=data,
...
#' @template seealso
#' @export
buildgam <- function (formula,data=NULL,family='gaussian',cl=NULL,direction=c('order','backward'),crit='LRT',keep=NULL,calc.anova=TRUE,calc.summary=TRUE,quiet=FALSE,...) {
	p <- list(
		formula=formula,
		data=data,
		family=substitute(family),
...
#' @template seealso
#' @export
buildgamm4 <- function (formula,data=NULL,family='gaussian',cl=NULL,direction=c('order','backward'),crit='LRT',keep=NULL,reduce.fixed=TRUE,reduce.random=TRUE,calc.anova=TRUE,calc.summary=TRUE,ddf='Wald',quiet=FALSE,...) {
...
#' @template seealso
#' @export
buildglmmTMB <- function (formula,data=NULL,family='gaussian',cl=NULL,direction=c('order','backward'),crit='LRT',keep=NULL,reduce.fixed=TRUE,reduce.random=TRUE,calc.summary=TRUE,quiet=FALSE,...) {
...
#' @template seealso
#' @export
buildgls <- function (formula,data=NULL,cl=NULL,direction=c('order','backward'),crit='LRT',keep=keep,calc.anova=TRUE,calc.summary=TRUE,quiet=FALSE,...) {
...
#' @template seealso
#' @export
buildjulia <- function (formula,data=NULL,family='gaussian',julia_family=NULL,julia_link=NULL,julia_fun=NULL,cl=NULL,direction=c('order','backward'),crit='LRT',reduce.fixed=TRUE,reduce.random=TRUE,quiet=FALSE,...) {
...
#' @template seealso
#' @export
buildlme <- function (formula,data=NULL,random,cl=NULL,direction=c('order','backward'),crit='LRT',keep=keep,calc.anova=TRUE,calc.summary=TRUE,quiet=FALSE,...) {
	if (!requireNamespace('nlme')) stop('Please install package nlme')
	p <- list(
		formula=formula,
		data=data,
...
#' }
#' @export
buildmer <- function (formula,data=NULL,family='gaussian',cl=NULL,direction=c('order','backward'),crit='LRT',keep=NULL,reduce.fixed=TRUE,reduce.random=TRUE,calc.anova=TRUE,calc.summary=TRUE,ddf='Wald',quiet=FALSE,...) {
	p <- list(
		formula=formula,
		data=data,
		family=substitute(family),
...
#' @template seealso
#' @export
buildmultinom <- function (formula,data=NULL,cl=NULL,direction=c('order','backward'),crit='LRT',keep=NULL,calc.summary=TRUE,quiet=FALSE,...) {
