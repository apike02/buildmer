...
Fitting with REML: f1 ~ following + vowel + timepoint + vowel:timepoint + following:timepoint + following:vowel + following:vowel:timepoint + (1 + timepoint | word) + (1 + timepoint + following | participant)
      ...
      grouping                      term                              block           LRT Iteration
1         <NA>                         1                            NA NA 1            NA         1
2         <NA>                 following                    NA NA following            NA         1
3         <NA>                     vowel                        NA NA vowel            NA         1
4         <NA>                 timepoint                    NA NA timepoint            NA         1
5         <NA>           vowel:timepoint              NA NA vowel:timepoint            NA         1
6         <NA>       following:timepoint          NA NA following:timepoint            NA         1
7         <NA>           following:vowel              NA NA following:vowel            NA         1
8         <NA> following:vowel:timepoint    NA NA following:vowel:timepoint  7.223287e-08         1
9         word                         1                          NA word 1            NA         1
10        word                 timepoint                  NA word timepoint 2.134598e-153         1
11 participant                         1                   NA participant 1            NA         1
12 participant                 timepoint           NA participant timepoint            NA         1
13 participant                 following           NA participant following            NA         1
14 participant       timepoint:following NA participant timepoint:following  8.319280e-11         1
